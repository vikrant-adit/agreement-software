export const arrFeatures: { [key: string]: string[] } = {
  ...
  ZocDoc: ['Real-Time Online Scheduling', 'Appts Book Directly into PMS'],

  AT_T: [],
  Bell: [],
  Comcast: ['VoIP Phones', 'Visual Voicemails'],

  xFinity: ['VoIP Phones', 'Visual Voicemails'],
  ...
  Spectrum: ['VoIP Phones', 'Visual Voicemails'],

  Verizon: ['VoIP Phones', 'Visual Voicemails'],
