...
@Component({
  ...
  imports: [DatePipe, HeaderComponent, MatIconModule, MatFormFieldModule, MatButtonModule, MatInputModule, MatToolbarModule, MatTableModule, MatPaginatorModule, MatSelectModule, MatTooltipModule, MatDatepickerModule],
  templateUrl: './users.component.html',
  styleUrl: './users.component.scss'
})
export class UsersComponent implements OnInit {
  // displayedColumns: string[] = ['id', 'name', 'email', 'designation', 'user_group', 'created_at', 'actions'];
  displayedColumns: string[] = ['id', 'name', 'email', 'role_name', 'user_group', 'created_at', 'actions'];
